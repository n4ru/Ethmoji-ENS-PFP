...
The NFT contract might change in the future, and we want to force clients to update their code with the new address.
But, we want to avoid making duplicates of the data, or having to migrate it.
